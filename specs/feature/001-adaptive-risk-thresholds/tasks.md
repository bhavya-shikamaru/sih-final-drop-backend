...
- [ ] T002 Create the Zod validation schemas for threshold creation and updates in `src/validation/schemas/config.schema.ts`.
- [ ] T003 Create the new router file for configuration at `src/routes/config.routes.ts`.
